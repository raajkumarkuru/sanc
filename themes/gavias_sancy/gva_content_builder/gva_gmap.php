   ...
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
         ...
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_sancy')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_sancy')) ?>/vendor/jquery.ui.map.min.js"></script>
