		...
		return array(
         ...
         'key'    => 'gva_column',
            ...
            array(
              'id'    => 'class_available',
              'type'    => 'select',
              'title'   => ('CSS classes available'),
              'options'   => array(
                  ''                                       => '---',   
                  'main_content sleft'                     => 'main_content sleft',
                  'main_content sright'                    => 'main_content sright',
                  'main_content sleft sright'              => 'main_content sleft sright',
                  'sidebar sleft'                          => 'sidebar sleft',
                  'sidebar sright'                         => 'sidebar sright',
